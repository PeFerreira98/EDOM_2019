...
public class GorgeousfoodPackageImpl extends EPackageImpl implements GorgeousfoodPackage {
	...
	public static GorgeousfoodPackage init() {
		...
		GorgeousfoodPackageImpl theGorgeousfoodPackage = (GorgeousfoodPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof GorgeousfoodPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
