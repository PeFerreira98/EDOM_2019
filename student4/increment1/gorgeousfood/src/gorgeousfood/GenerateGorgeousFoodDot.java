...
import edom.gorgeousfood.impl.SaleImpl;
import edom.gorgeousfood.*;

public class GenerateGorgeousFoodDot {
	...
	public static void loadModel() {
		...
		Resource resource = resSet.getResource(URI.createURI("instances/exemplo1.gorgeousfood"), true);
