 ...
 */
package pt.isep.edom.mmapdsl.services;
...
@Singleton
public class MMapDslGrammarAccess extends AbstractGrammarElementFinder {
	
	public class MapElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "pt.isep.edom.mmapdsl.MMapDsl.Map");
	...
	public class MapElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "pt.isep.edom.mmapdsl.MMapDsl.MapElement");
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "pt.isep.edom.mmapdsl.MMapDsl.EString");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class RelationshipElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "pt.isep.edom.mmapdsl.MMapDsl.Relationship");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TopicElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "pt.isep.edom.mmapdsl.MMapDsl.Topic");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EDateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "pt.isep.edom.mmapdsl.MMapDsl.EDate");
	...
	public class TypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "pt.isep.edom.mmapdsl.MMapDsl.Type");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class PriorityElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "pt.isep.edom.mmapdsl.MMapDsl.Priority");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	@Inject
	public MMapDslGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("pt.isep.edom.mmapdsl.MMapDsl".equals(grammar.getName())) {
				return grammar;
			}
