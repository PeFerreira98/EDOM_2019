...
/**
 * This is the item provider adapter for a {@link edom.gorgeousfood.Sale} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SaleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSaleIDPropertyDescriptor(object);
	 ...
	 * @generated
	 */
	protected void addSaleIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Sale_SaleID_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Sale_SaleID_feature", "_UI_Sale_type"),
						GorgeousfoodPackage.Literals.SALE__SALE_ID, true, false, false,
	...
	protected void addDatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						GorgeousfoodPackage.Literals.SALE__DATE, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GorgeousfoodPackage.Literals.SALE__MEALITEM);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Sale_type") + " " + sale.getSaleID();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(GorgeousfoodPackage.Literals.SALE__MEALITEM,
				GorgeousfoodFactory.eINSTANCE.createMealItem()));
	}
