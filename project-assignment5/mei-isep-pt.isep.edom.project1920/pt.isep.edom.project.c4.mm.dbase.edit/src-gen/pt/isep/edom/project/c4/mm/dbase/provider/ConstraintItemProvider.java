...
/**
 * This is the item provider adapter for a {@link pt.isep.edom.project.c4.mm.dbase.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Constraint_name_feature",
								"_UI_Constraint_type"),
						DbasePackage.Literals.CONSTRAINT__NAME, true, false, false,
	...
	protected void addConstraintTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Constraint_constraintType_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Constraint_constraintType_feature",
								"_UI_Constraint_type"),
						DbasePackage.Literals.CONSTRAINT__CONSTRAINT_TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
