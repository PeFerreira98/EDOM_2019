...
/**
 * This is the item provider adapter for a {@link pt.isep.edom.project.c4.mm.dbase.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DbasePackage.Literals.TABLE__NAME, true, false, false,
	...
	protected void addEntityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DbasePackage.Literals.TABLE__ENTITY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DbasePackage.Literals.TABLE__COLUMNS);
			childrenFeatures.add(DbasePackage.Literals.TABLE__CONSTRAINT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(DbasePackage.Literals.TABLE__COLUMNS, DbaseFactory.eINSTANCE.createColumn()));

		newChildDescriptors.add(createChildParameter(DbasePackage.Literals.TABLE__CONSTRAINT,
				DbaseFactory.eINSTANCE.createConstraint()));
	}
