 ...
 * <!-- end-user-doc -->
 * @see pt.isep.edom.project.c4.mm.dbase.DbasePackage#getCardinalityType()
 * @model
 * @generated
 */
public enum CardinalityType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final CardinalityType[] VALUES_ARRAY = new CardinalityType[] { ONE_TO_ONE, ONE_TO_MANY,
			MANY_TO_MANY, };
